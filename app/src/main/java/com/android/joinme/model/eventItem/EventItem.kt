 ...
 *
 * This allows mixing events and series in a single list while maintaining type safety.
 * Each subtype provides common properties (eventItemId, title, date) for uniform sorting and display.
 */
