...
/**
 * Room database for offline caching. Stores events, series, and profiles locally for offline
 * viewing.
 *
 ...
 */
@Database(
    entities = [EventEntity::class, SerieEntity::class, ProfileEntity::class],
    version = 3,
    exportSchema = false)
