...
/**
 * Firestore implementation of [ProfileRepository] that manages user profile data
 * in Firebase Firestore.
 *
 * This repository provides CRUD operations for user profiles, storing them in a
 * Firestore collection. Each profile document is keyed by the user's UID. All operations
 * are asynchronous and use Kotlin coroutines for clean, non-blocking execution.
 *
