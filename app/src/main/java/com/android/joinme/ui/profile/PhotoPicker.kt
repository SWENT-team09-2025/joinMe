...
/**
 * Alternative implementation using GetContent for broader compatibility.
 *
 * Use this if you need to support devices that don't have the modern Photo Picker,
 * though PickVisualMedia already falls back gracefully on older devices.
 *
 * This opens the system file picker filtered to images.
 */
@Composable
        ...
        PhotoPickerLauncher(
            launch = {
                try {
                    ...
                    onError("Failed to open image picker: ${e.message}")
                }
            }
        )
    }
