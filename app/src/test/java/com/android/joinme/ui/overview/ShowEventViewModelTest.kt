...
/** Note: this file was generated by AI (Claude) and reviewed by a human. */
...
class ShowEventViewModelTest {
  ...
  fun loadEvent_validEventId_updatesUIState() = runTest {
    ...
    assertNotNull(state.locationCoordinates)
    assertEquals(46.5197, state.locationCoordinates!!.latitude, 0.0001)
    assertEquals(6.6323, state.locationCoordinates!!.longitude, 0.0001)
    assertEquals("EPFL", state.locationCoordinates!!.name)
  ...
  @Test
  fun loadEvent_eventWithLocation_setsLocationNameAndCoordinates() = runTest {
    val event = createTestEvent()
    repository.addEvent(event)
