...
class ActivityGroupScreenTest {
    ...
    fun activityGroupScreen_displaysTopBarAndBackButton() {
        ...
        composeTestRule.setContent { ActivityGroupScreen(groupId = "1", activityGroupViewModel = viewModel) }
    ...
    fun activityGroupScreen_backButtonTriggersCallback() {
        ...
        composeTestRule.setContent {
            ActivityGroupScreen(
                groupId = "1", activityGroupViewModel = viewModel, onNavigateBack = { backClicked = true })
        }
    ...
    fun activityGroupScreen_emptyState_displaysCorrectMessage() {
        ...
        composeTestRule.onNodeWithTag(ActivityGroupScreenTestTags.EMPTY_ACTIVITY_LIST_MSG).assertIsDisplayed()
    ...
    fun activityGroupScreen_handlesErrorFromRepository() {
        ...
        composeTestRule.onNodeWithTag(ActivityGroupScreenTestTags.LOADING_INDICATOR).assertDoesNotExist()
        composeTestRule
    ...
    fun activityGroupScreen_groupWithOnlyEvents_displaysCorrectly() {
        ...
        runBlocking {
            ...
            groupRepo.addGroup(
                Group(
                    id = "1", name = "Events Only Group", eventIds = listOf("event1", "event2")))
        }
