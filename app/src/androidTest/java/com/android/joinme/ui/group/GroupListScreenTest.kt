...
class GroupListScreenTest {
    ...
    fun floatingActionButton_whenClicked_showsBubbles() {
        ...
        composeTestRule
            .onNodeWithTag(GroupListScreenTestTags.ADD_NEW_GROUP)
            .performClick()
    ...
    fun floatingActionBubbles_displaysCorrectActions() {
        ...
        composeTestRule
            .onNodeWithText("Join with link")
            .assertIsDisplayed()

        composeTestRule
            .onNodeWithText("Create a group")
            .assertIsDisplayed()
    }
    ...
    fun floatingActionBubbles_createGroupBubble_hasCorrectTestTag() {
        ...
        composeTestRule
            .onNodeWithTag("groupCreateBubble")
            .assertIsDisplayed()
            .assertHasClickAction()
    }
    ...
    fun floatingActionBubbles_bubblesHaveIcons() {
        ...
        composeTestRule
            .onNodeWithContentDescription("Join with link")
            .assertIsDisplayed()

        composeTestRule
            .onNodeWithContentDescription("Create a group")
            .assertIsDisplayed()
    }
