...
class GroupDetailScreenTest {
    ...
    fun groupEventsButton_triggersCallback() {
        ...
        composeTestRule.setContent {
            GroupDetailScreen(
                groupId = "group1",
                viewModel = viewModel,
                onGroupEventsClick = { buttonClicked = true })
        }
    ...
    fun successfulLoad_withEmptyDescription_displaysCorrectly() {
        ...
        composeTestRule.waitUntil(timeoutMillis = 3000) {
            composeTestRule.onAllNodesWithText("No Description Group").fetchSemanticsNodes()
                .isNotEmpty()
        }
    ...
    fun successfulLoad_withSpecialCharactersInName_displaysCorrectly() {
        ...
        composeTestRule.waitUntil(timeoutMillis = 3000) {
            composeTestRule.onAllNodesWithText("Café & Brunch Club ☕").fetchSemanticsNodes()
                .isNotEmpty()
        }
